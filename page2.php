...
<div class="row justify-content-center mt-5 mb-5">
  <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <figure>
            <img src="rumus-glbb-2.png" alt="Rumus Kecepatan Akhir" style="max-width: 200px;">
            <figcaption>Rumus Kecepatan Akhir</figcaption>
          </figure>
          <figure>
            <img src="rumus-glbb-1.png" alt="Rumus Jarak Tempuh" style="max-width: 200px;">
            <figcaption>Rumus Jarak Tempuh</figcaption>
          </figure>
          <?php
